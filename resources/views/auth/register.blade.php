                                    ...
                                    <form class="form-horizontal auth-form" method="POST"
                                        ...
                                        <div class="d-flex align-items-center mb-3 pb-1">
                                            <span class="h1 fw-bold mb-0"
                                                style="position: relative; right: 16px;">Company Registration</span>
                                        </div>
                                        <div class="form-outline mb-4">
                                            <label for="name">Full Company Name</label>
                                            <input id="name" placeholder="Full Company Name" type="text"
                                        ...
                                        <div class="form-outline mb-4">
                                            <label class="form-label" for="form2Example17">Company registration
                                                Number</label>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <div>
                                            <input id="company_certificate" type="file"
                                                class="d-none @error('name') is-invalid @enderror" name="name"
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <div>
                                            <input id="company_certificate" type="file"
                                                class="mt-2 d-none @error('name') is-invalid @enderror" name="name"
                                                value="{{ old('name') }}" required>
                                            <label for="company_certificate" class="btn btn-success btn-md">
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <div>
                                            <input id="company_certificate" type="file"
                                                class="mt-1 d-none @error('name') is-invalid @enderror" name="name"
                                                value="{{ old('name') }}" required>
                                            <label for="company_certificate" class="btn btn-success btn-md">
                                                <i class="fas fa-plus"></i> Upload
                                            </label>
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <div class="pt-1 mt-3">
                                            <button class="btn w-100"
                                                style="background-color: #CCF148; color:##178B7B;"
                                                type="submit">Submit</button>
                                        </div>
                                        <div class="d-flex flex-row justify-content-end">
                                            <a href="{{ route('login') }}"
                                                style="color: #393f81; text-decoration: none;">Login here</a>
                                        </div>
                                    </div>
                                    </form>
                                </div>
