...
{{--
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a class="sidebar-header" href="" style="">
                        <!-- Updated SVG for Request -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-list">
                            <path d="M4 6h16M4 12h16M4 18h16"></path>
                        </svg>
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a class="sidebar-header" href="{{ route('investor.request.index') }}" style="{{ request()->routeIs('investor.request.index') ? 'background-color: white; color: #214d45;' : '' }}">
                        <!-- New SVG for Investments -->
                ...
                <li>
                    <a class="sidebar-header" href="{{ route('investor.profile.edit') }}" style="{{ request()->routeIs('investor.profile.edit') ? 'background-color: white; color: #214d45;' : '' }}">
                        <!-- New SVG for Personal Information -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user">
                            <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4z"></path>
                            <path d="M12 14c-3.31 0-6 1.69-6 3v1h12v-1c0-1.31-2.69-3-6-3z"></path>
                        </svg>
